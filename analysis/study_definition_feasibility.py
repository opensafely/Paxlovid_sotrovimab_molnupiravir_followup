...
study = StudyDefinition(
  ...
  #   returning = "date",   #returning = "therapeutic", (qw-commented out)
  #   date_format = "YYYY-MM-DD",  #qw-added
  #   return_expectations = {      #qw-added
  #     "date": {"earliest": "2021-12-16"},  #qw-added
  #     "incidence": 0.4  #qw-added
  #   }, #qw-added
  # ),
  ...
  #   on_or_after = "index_date",
  #   find_first_match_in_period = True,
  #   returning = "date",   #returning = "therapeutic",
  #   date_format = "YYYY-MM-DD",  #added -2023-12-02
  #   return_expectations = {      #qw-added
  #     "date": {"earliest": "2021-12-16"},  #qw-added
  #     "incidence": 0.4  #qw-added
  #   },
